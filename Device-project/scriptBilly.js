...
function setup() {
  setInterval(() => fetchText('logBilly.json'), 5000);
  fetchText('logBilly.json'); 
}
...
function getResponse(data) {
  ...
  try {
    ...
    const humidEl = document.getElementById('humid2');
    const feltEl = document.getElementById('felt2');
    ...
    if (feltEl && obj.felt !== undefined) {
      ...
      document.documentElement.style.setProperty('--felt2-num', mappedValue);
    }
