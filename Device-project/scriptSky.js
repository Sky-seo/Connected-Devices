...
function setup() {
  setInterval(() => fetchText('logSky.json'), 5000);
  fetchText('logSky.json'); 
}
...
function getResponse(data) {
  ...
  try {
    ...
    const humidEl = document.getElementById('humid1');
    const feltEl = document.getElementById('felt1');
    ...
    if (feltEl && obj.felt !== undefined) {
      ...
      document.documentElement.style.setProperty('--felt1-num', mappedValue);
    }
